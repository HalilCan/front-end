...
function renderBoxes() {
  ...
  for (var i = 0; i < len; i ++) {
    ...
    boxLi.innerHTML = ("<div id = 'timeBlock-" + i + "' class = 'time-block'> <form> <input id = 'minBox-" + i + "' class = 'min-box' type='text' name='mins' value="+ boxMinutes +">:<input id = 'secBox-"+ i +"' class = 'sec-box' type='text' name='secs' value="+ box.seconds%60 +"><input id = 'labelBox-"+ i +"' class = 'label-box' type='text' name='label' value="+ box.label +"> <input id = 'delete-"+ i +"' class = 'delete-btn' type='button' value='X' onclick = 'deleteBox("+i+");'> </form> </div>");
